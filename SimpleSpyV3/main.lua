...
local LazyFix = loadstring(game:HttpGet("https://raw.githubusercontent.com/Erchobg/InfYield/refs/heads/main/SimpleSpyV3/DataToCode.lua"))() -- Very lazy fix as I'm legit just pasting it from the rewrite
